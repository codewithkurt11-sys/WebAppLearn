...
export default function Profile() {
  ...
  /* Chart data */
  const chartData = skills.map(s => ({ name: s.label, pct: s.pct }));
          ...
          <div style={{ width: "100%", height: 200 }}>
            <ResponsiveContainer>
              <BarChart data={chartData} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                <XAxis dataKey="name" tick={{ fill: T.muted2, fontSize: 11 }} axisLine={{ stroke: T.border }} tickLine={false} />
                ...
                />
                <Bar dataKey="pct" fill={T.accent} radius={[4,4,0,0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
